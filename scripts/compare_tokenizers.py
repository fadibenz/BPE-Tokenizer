...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Running comparison between tokenizers")
    parser.add_argument("--tokenizer_a", type=str, required=True,
                        help="Path to vocab.json and merges.txt for first tokenizer")
    parser.add_argument("--tokenizer_b", type=str, required=True,
                        help="Path to vocab.json and merges.txt for second tokenizer")
